...
function CloudDownload(props) {
	...
	<title>{title}</title>
	<g fill="#000000">
		<path d="M36.3 35.2l-2.5 2.6v-8.5c0-1-.8-1.8-1.8-1.8s-1.8.8-1.8 1.8v8.5l-2.5-2.6c-.7-.7-1.8-.7-2.5 0s-.7 1.8 0 2.5l4.9 5.1c.5.5 1.1.8 1.8.8s1.3-.3 1.8-.8l4.9-5.1c.7-.7.7-1.8 0-2.5-.6-.7-1.7-.7-2.3 0z"/>
